...
export default class QuestionnaireForm extends Component {
          ...
          item.extension.forEach(e => {
            if (
              ...
              this.updateQuestionValue(
                item.linkId,
                this.props.cqlPrepoulationResults[value],
                "values"
              );
            }
          });
  ...
  outputResponse(status) {
    ...
    // const priorAuthUrl =
    //   "http://ec2-34-201-148-138.compute-1.amazonaws.com:8080/fhir/Claim/$submit";
    ...
    Http.onreadystatechange = function() {
      if (this.readyState === XMLHttpRequest.DONE) {
        ...
        let priorAuthUri =
          ...
          "&patient.identifier=" +
          patientEntry.resource.identifier[0].value;
  ...
  isEmptyAnswer(answer) {
    return (
      ...
      (answer[0].hasOwnProperty("valueBoolean") &&
        (answer[0].valueBoolean == null || answer[0].valueBoolean == "")) ||
  ...
  render() {
    return (
      <div>
        ...
        <button className="btn submit-button" onClick={this.outputResponse}>
          Submit
        </button>
      </div>
    );
