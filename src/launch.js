...
if (serviceUri) {
  ...
  function redirect(conformanceStatement) {
    ...
    if (serviceUri.search('3.92.187.150') > 0) {
      authUri = "https://3.92.187.150:8443/auth/realms/ProviderCredentials/protocol/openid-connect/auth";
      tokenUri = "https://3.92.187.150:8443/auth/realms/ProviderCredentials/protocol/openid-connect/token"
    } else {
